...
} else if($_GET['action'] == 2 && $_SESSION['valide'] == 1){
            ...
            <div class="menu">
               <div class="panel panel-default">
                ...
                <ul class="menu-links">
                    ...
                    <li class="nav-link">
                    <a class="download-button" onclick="generatePDF(<?php echo $e = isset($_SESSION['id'])?$_SESSION['id'] : '' ?>)">
                    ...
                    <div class="card-block" >
                        <form id="main" method="post" action="/" novalidate=""  >
                            <div class="card-header" >
                                <h5 class="text-right" style="font-size: 1.3rem; font-weight: bolder;">Date paiement :  <b><?php echo $dat_reverse = substr($_SESSION['datepaiement'],8,10).'-'.substr($_SESSION['datepaiement'],5,2).'-'.substr($_SESSION['datepaiement'],0,4);?></b></h5>
                            </div>
                            <div>
                              <table>
                                  <div id="77">
                                ...
                                <div class="form-group row" >
                                    ...
                                    <p id="textei" style="font-size: 1.2rem;">
                                        Je soussigné(e)   <b><?php echo $_SESSION['bailleur'];?></b>   propriétaire/bailleur du logement désigné ci-dessus, déclare avoir recu de Monsieur/Madame  <b><?php echo $_SESSION['locataire'];?></b>
                                            ...
                                            la somme <?php?>  (en toutes lettres), <?php?> (en chiffres), de <?php echo $_SESSION['total'];?> F CFA au titre du paiement du loyer et des charges pour la période de location du  <b><?php echo $dat_reverse = substr($_SESSION['datedebut'],8,10).'-'.substr($_SESSION['datedebut'],5,2).'-'.substr($_SESSION['datedebut'],0,4);?></b>   au  <b><?php echo $dat_reverse = substr($_SESSION['datefin'],8,10).'-'.substr($_SESSION['datefin'],5,2).'-'.substr($_SESSION['datefin'],0,4);;?></b> ,et lui en donne quittance, sous reserve de tous mes droits.
                                    </p> 
                                </div>
                                <div>
                                  <table>
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                          <td class='select'>
                                            ...
                                            <td class='select'>
                                            <b><?php echo  $_SESSION['total']." FCFA";?></b>
                                            </td>
                                          </td>
                                        </tr>
                                      </tbody>
