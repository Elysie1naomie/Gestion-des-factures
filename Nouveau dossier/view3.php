                            ...
                            <section class="haut">
                                ...
                                <section class="hautd">
                                    <div  class="card-header" style=" width: 12cm; font-size: 2rem; font-family:britannic bold; text-decoration:solid;">
                                        ...
                                        <p style="font-size: 1.1rem;">RECU de Mr/Mme  <b><?php echo $_SESSION['locataire'];?></p>
                                    </div>
                                </section>       
                            </section>  <br>      
                            <div class="form-group row" >
                                <p style="font-size: 1.2rem;">
                                    La somme de <b><?php echo  $_SESSION['total'];?></b><br> pour le montant  <b><?php echo $_SESSION['nbrmois'];?></b>  d'un mois de loyer des locaux qu'il/qu'elle occupe dans la maison situee
                                    
                                    <b><?php echo $_SESSION['ville'];?></b> <br> le dit  <b><?php echo $_SESSION['immobilier'];?> </b> commencant le  <b><?php echo $_SESSION['datedebut'];?></b> et finissant le   <b><?php echo $_SESSION['datefin'];?></b> sous toutes reserves de droit DONT QUITTANCE.
                                </p> 
                            </div>
                        </div>
                    </div>
