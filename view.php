                    ...
                    <div class="card-block" style="background-color: white;">
                        ...
                        <div class="card-header" >
                                ...
                                <div class="form-group row" >
                                    ...
                                    <p id="textei" style="font-size: 1.2rem;">
                                        Je soussigné(e)   <b><?php echo $_SESSION['bailleur'];?></b>   propriétaire/bailleur du logement désigné ci-dessus, déclare avoir recu de Monsieur/Madame  <b><?php echo $_SESSION['locataire'];?></b>
                                            ...
                                            la somme <?php?>  (en toutes lettres), <?php?> (en chiffres),<?php echo $_SESSION['total'];?> au titre du paiement du loyer et des charges pour la période de location du  <b><?php echo $dat_reverse = substr($_SESSION['datedebut'],8,10).'-'.substr($_SESSION['datedebut'],5,2).'-'.substr($_SESSION['datedebut'],0,4);?></b>   au  <b><?php echo $dat_reverse = substr($_SESSION['datefin'],8,10).'-'.substr($_SESSION['datefin'],5,2).'-'.substr($_SESSION['datefin'],0,4);?></b> ,et lui en donne quittance, sous reserve de tous mes droits.
                                    </p> 
                                </div>
                            </div>
                            ...
                            <div class="text2" style="background-color: white;">
                                <div>
                                    <h5  id="texte2" style="font-size: 1.3rem; font-weight: bolder; color: black;">DETAILS DE PAIEMENT :</h5>
                                </div>
                            </div>
